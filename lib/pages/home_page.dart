...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      _currentIndex == 1 ? CoursesPage(user:widget.user): 
      ProfilePage(
      ...
      child: ListView(
        ...
        children: [
          ...
          ListTile(
            ...
            title: Text("Settings"),
            onTap: () {
              Navigator.push(context, MaterialPageRoute(builder: (_) => SettingsPage(widget.user.email ?? '')));
            },
          ),
          ListTile(
            ...
            onTap: () {
              Navigator.push(context, MaterialPageRoute(builder: (_) => InviteFriend()));
            },
          ),
          ListTile(
